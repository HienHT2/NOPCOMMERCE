 ...
 *
 */
public class Level_12_Register_Login_Element_Undispalyed extends AbstractTest {
	WebDriver driver;
	Select select;
	...
	public void LevelTC01_Register() {
		...
		//Verify Login Link Displayed->Pass
	...
	public void LevelTC02_Login() {
		...
		// homePage = new HomePageObject(driver);
		//Verify My account Link Displayed=>False
	
		verifyFalse(homePage.isMyAccountLinkDisplayed());
		//Verify logout Link Dispalyes=>passs

		verifyFalse(homePage.isLogoutLinkDisplayed());
		//Verify shopping Link Dispalyes=>False
		verifyFalse(homePage.isShoppingCartNoItemToolTipUnDisplayed());
		//Verify login Link Undisplayed=?Pass
		
		verifyFalse( homePage.isRegisterLinkUnDisplayed());
		//Verify Register Link Undisplayed =>Fail
